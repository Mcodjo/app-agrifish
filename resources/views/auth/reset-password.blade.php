<x-guest-layout>
    <div class="mb-8">
        <h1 class="text-3xl font-extrabold text-gray-900">Réinitialiser le mot de passe</h1>
        <p class="mt-2 text-sm text-gray-600">Choisissez un nouveau mot de passe sécurisé pour votre compte.</p>
    </div>
